...
public class Transaction_ESTest extends Transaction_ESTest_scaffolding {
  ...
  public void test3()  throws Throwable  {
      Transaction transaction0 = new Transaction();
      Account account0 = new Account();
      account0.balance = (-7079);
      Account account1 = new Account();
      boolean boolean0 = transaction0.transfer(account1, account0, 707);
      assertFalse(boolean0);
  }
  ...
  public void test4()  throws Throwable  {
      ...
      Account account0 = new Account();
      account0.balance = (-7079);
      boolean boolean0 = transaction0.transfer(account0, account0, 707);
      assertFalse(boolean0);
  }
  ...
  public void test7()  throws Throwable  {
      Transaction transaction0 = new Transaction();
      Account account0 = new Account();
      boolean boolean0 = transaction0.transfer(account0, account0, (-7079));
      assertFalse(boolean0);
  }
}
